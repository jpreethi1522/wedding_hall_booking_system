...
?>
        ...
        <form onsubmit="return validateForm(); " id="bookingForm" action="send.php" method="post">
        <div class="row">
            <!-- Groom Details -->
            <div class="col-md-6">
                <h3 class="blue-heading">GROOM'S DETAILS</h3>
                <div class="form-group">
                    <label for="groomName">Groom's Name:</label>
                    <input type="text" class="form-control custom-input" id="groomName" name="groomName" placeholder="Enter Groom's Name" required>
                </div>
                <div class="form-group">
                    <label for="groomFatherName">Groom's Father's Name:</label>
                    <input type="text" class="form-control custom-input" id="groomFatherName" name="groomFatherName" placeholder="Enter Groom's Father's Name" required>
                </div>
                <div class="form-group">
                    <label for="groomMotherName">Groom's Mother's Name:</label>
                    <input type="text" class="form-control custom-input" id="groomMotherName" name="groomMotherName" placeholder="Enter Groom's Mother's Name" required>
                </div>
            </div>
            <!-- Bride Details -->
            <div class="col-md-6">
                <h3 class="blue-heading">BRIDE'S DETAILS</h3>
                <div class="form-group">
                    <label for="brideName">Bride's Name:</label>
                    <input type="text" class="form-control custom-input" id="brideName" name="brideName" placeholder="Enter Bride's Name" required>
                </div>
                <div class="form-group">
                    <label for="brideFatherName">Bride's Father's Name:</label>
                    <input type="text" class="form-control custom-input" id="brideFatherName" name="brideFatherName" placeholder="Enter Bride's Father's Name" required>
                </div>
                <div class="form-group">
                    <label for="brideMotherName">Bride's Mother's Name:</label>
                    <input type="text" class="form-control custom-input" id="brideMotherName" name="brideMotherName" placeholder="Enter Bride's Mother's Name" required>
                </div>
            </div>
        </div>
       <!-- Contact Details -->
       <h3 class="blue-heading text-left">Contact Details</h3>
       <div class="form-row">
           <div class="col-md-4">
               <label for="contactName">Contact Name:</label>
               <input type="text" class="form-control custom-input" id="contactName" name="contactName" placeholder="Enter Contact's Name" required>
           </div>
           <div class="col-md-4">
               <label for="contactNumber">Phone:</label>
               <input type="number" class="form-control custom-input" id="contactNumber" name="contactNumber" placeholder="Enter Contact's Number" required>
           </div>
           <div class="col-md-4">
               <label for="contactEmail">Email:</label>
               <input type="email" class="form-control custom-input" id="contactEmail" name="contactEmail" placeholder="Enter Contact's Email" required>
           </div>
       </div>
    
       <!-- Preferred Dates -->
       <h3 class="blue-heading text-left">Preferred Dates</h3>
       <div class="form-group">
           <div class="row">
               <label for="preferredDate1" class="col-sm-2 col-form-label">Preferred Date 1:</label>
               <div class="col-sm-4">
                   <input type="date" class="form-control custom-input" id="preferredDate1" name="preferredDate1" min="<?php echo date('Y-m-d'); ?>" required>
               </div>
               <div class="col-sm-6">
                   <div class="form-check form-check-inline">
                       <input class="form-check-input" type="radio" name="hallPreference1" id="mainHall1" value="mainHall" required>
                       <label class="form-check-label" for="mainHall1">MAIN HALL</label>
                   </div>
                   <div class="form-check form-check-inline">
                       <input class="form-check-input" type="radio" name="hallPreference1" id="northHall1" value="northHall" required>
                       <label class="form-check-label" for="northHall1">NORTH HALL</label>
                   </div>
               </div>
           </div>
       </div>
       <div class="form-group">
           <div class="row">
               <label for="preferredDate2" class="col-sm-2 col-form-label">Preferred Date 2:</label>
               <div class="col-sm-4">
               <input type="date" class="form-control custom-input" id="preferredDate2" name="preferredDate2" min="<?php echo date('Y-m-d'); ?>" required>
               </div>
               <div class="col-sm-6">
                   <div class="form-check form-check-inline">
                       <input class="form-check-input" type="radio" name="hallPreference2" id="mainHall2" value="mainHall">
                       <label class="form-check-label" for="mainHall2">MAIN HALL</label>
                   </div>
                   <div class="form-check form-check-inline">
                       <input class="form-check-input" type="radio" name="hallPreference2" id="northHall2" value="northHall">
                       <label class="form-check-label" for="northHall2">NORTH HALL</label>
                   </div>
               </div>
           </div>
       </div>
       <div class="form-group">
           <div class="row">
               <label for="preferredDate3" class="col-sm-2 col-form-label">Preferred Date 3:</label>
               <div class="col-sm-4">
               <input type="date" class="form-control custom-input" id="preferredDate3" name="preferredDate3" min="<?php echo date('Y-m-d'); ?>" required>
               </div>
               <div class="col-sm-6">
                   <div class="form-check form-check-inline">
                       <input class="form-check-input" type="radio" name="hallPreference3" id="mainHall3" value="mainHall">
                       <label class="form-check-label" for="mainHall3">MAIN HALL</label>
                   </div>
                   <div class="form-check form-check-inline">
                       <input class="form-check-input" type="radio" name="hallPreference3" id="northHall3" value="northHall">
                   <label class="form-check-label" for="northHall3">NORTH HALL</label>
               </div>
           </div>
       </div>
...
<div id="loading" style="display: none;">
    <img src="Dual Ball@1x-1.0s-200px-200px.gif" alt="Loading...">
</div>
